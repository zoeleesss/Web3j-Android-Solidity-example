...
public class Contants {
    ...
    public static class API{
        ...
        public static final String FISH_IMG="http://myhomie.chinaxueyun.com/FishAlpha/index.php?gene=";
        public static final String FISH_RARE="http://myhomie.chinaxueyun.com/FishAlpha/rare.php?gene=";
